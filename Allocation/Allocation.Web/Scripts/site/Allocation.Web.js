...
(function (Allocation) {
    ...
    (function (Administration) {
        ...
        [['Username', function () { return Serenity.StringEditor; }], ['DisplayName', function () { return Serenity.StringEditor; }], ['Email', function () { return Serenity.EmailEditor; }], ['MobilePhoneNumber', function () { return Serenity.StringEditor; }], ['MobilePhoneVerified', function () { return Serenity.BooleanEditor; }], ['TwoFactorAuth', function () { return Serenity.EnumEditor; }], ['UserImage', function () { return Serenity.ImageUploadEditor; }], ['Password', function () { return Serenity.PasswordEditor; }], ['PasswordConfirm', function () { return Serenity.PasswordEditor; }], ['Source', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(UserForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Administration = Allocation.Administration || (Allocation.Administration = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
...
(function (Allocation) {
    ...
    (function (AdvancedSamples) {
        ...
        (function (DataExplorerService) {
            DataExplorerService.baseUrl = 'AdvancedSamples/DataExplorer';
            var Methods;
            (function (Methods) {
            })(Methods = DataExplorerService.Methods || (DataExplorerService.Methods = {}));
            [
                'ListConnections',
                'ListTables',
                'ListColumns',
                ...
                Methods[x] = DataExplorerService.baseUrl + '/' + x;
            });
        })(DataExplorerService = AdvancedSamples.DataExplorerService || (AdvancedSamples.DataExplorerService = {}));
    })(AdvancedSamples = Allocation.AdvancedSamples || (Allocation.AdvancedSamples = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    var AdvancedSamples;
    (function (AdvancedSamples) {
        var InlineButtonsForm = /** @class */ (function (_super) {
            __extends(InlineButtonsForm, _super);
            function InlineButtonsForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            InlineButtonsForm.formKey = 'AdvancedSamples.InlineButtons';
            return InlineButtonsForm;
        }(Serenity.PrefixedContext));
        AdvancedSamples.InlineButtonsForm = InlineButtonsForm;
        [['SomeTextInput', function () { return Serenity.StringEditor; }], ['InputWithButton', function () { return AdvancedSamples.InlineButtonsEditor; }], ['ExternallyCreatedButton', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(InlineButtonsForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(AdvancedSamples = Allocation.AdvancedSamples || (Allocation.AdvancedSamples = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    var AdvancedSamples;
    (function (AdvancedSamples) {
        var LongRunningService;
        (function (LongRunningService) {
            LongRunningService.baseUrl = 'AdvancedSamples/LongRunning';
            var Methods;
            (function (Methods) {
            })(Methods = LongRunningService.Methods || (LongRunningService.Methods = {}));
            [
                'Action',
                'Cancel',
                'Status'
            ].forEach(function (x) {
                LongRunningService[x] = function (r, s, o) {
                    return Q.serviceRequest(LongRunningService.baseUrl + '/' + x, r, s, o);
                };
                Methods[x] = LongRunningService.baseUrl + '/' + x;
            });
        })(LongRunningService = AdvancedSamples.LongRunningService || (AdvancedSamples.LongRunningService = {}));
    })(AdvancedSamples = Allocation.AdvancedSamples || (Allocation.AdvancedSamples = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    var AdvancedSamples;
    (function (AdvancedSamples) {
        var PickerOrderForm = /** @class */ (function (_super) {
            __extends(PickerOrderForm, _super);
            function PickerOrderForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            PickerOrderForm.formKey = 'AdvancedSamples.PickerOrder';
            return PickerOrderForm;
        }(Serenity.PrefixedContext));
        AdvancedSamples.PickerOrderForm = PickerOrderForm;
        [['CustomerID', function () { return Allocation.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return AdvancedSamples.PickerOrderDetailsEditor; }], ['ShippedDate', function () { return Serenity.DateEditor; }], ['ShipVia', function () { return Serenity.LookupEditor; }], ['Freight', function () { return Serenity.DecimalEditor; }], ['ShipName', function () { return Serenity.StringEditor; }], ['ShipAddress', function () { return Serenity.StringEditor; }], ['ShipCity', function () { return Serenity.StringEditor; }], ['ShipRegion', function () { return Serenity.StringEditor; }], ['ShipPostalCode', function () { return Serenity.StringEditor; }], ['ShipCountry', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(PickerOrderForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(AdvancedSamples = Allocation.AdvancedSamples || (Allocation.AdvancedSamples = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    ...
    })(BasicSamples = Allocation.BasicSamples || (Allocation.BasicSamples = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    var BasicSamples;
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return Allocation.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = Allocation.BasicSamples || (Allocation.BasicSamples = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return Allocation.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return Allocation.Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = Allocation.BasicSamples || (Allocation.BasicSamples = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        ...
        [['StaticText', function () { return Allocation.StaticTextBlock; }], ['SomeInput', function () { return Serenity.StringEditor; }], ['HtmlList', function () { return Allocation.StaticTextBlock; }], ['FromLocalText', function () { return Allocation.StaticTextBlock; }], ['DisplayFieldValue', function () { return Allocation.StaticTextBlock; }]].forEach(function (x) { return Object.defineProperty(StaticTextBlockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = Allocation.BasicSamples || (Allocation.BasicSamples = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
...
(function (Allocation) {
    ...
    })(Meeting = Allocation.Meeting || (Allocation.Meeting = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    var Meeting;
...
(function (Allocation) {
    ...
    })(Northwind = Allocation.Northwind || (Allocation.Northwind = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    var Northwind;
...
(function (Allocation) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'Allocation.Northwind.Entities.Gender');
    })(Northwind = Allocation.Northwind || (Allocation.Northwind = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
...
(function (Allocation) {
    ...
    })(Organization = Allocation.Organization || (Allocation.Organization = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    var Organization;
...
(function (Allocation) {
    var AdvancedSamples;
    (function (AdvancedSamples) {
        var InlineButtonsDialog = /** @class */ (function (_super) {
            __extends(InlineButtonsDialog, _super);
            function InlineButtonsDialog() {
                var _this = _super.call(this) || this;
                _this.form = new AdvancedSamples.InlineButtonsForm(_this.idPrefix);
                _this.dialogTitle = "Editors with inline actions";
                $('<a class="inplace-button inplace-action3"><b><i class="fa fa-magic text-red"></i></b></a>')
                    .attr("title", "Do Some Action 3")
                    .insertAfter(_this.form.ExternallyCreatedButton.element)
                    .click(function (e) {
                    Q.notifyWarning("Action 3 with magic wand clicked!");
                });
                return _this;
            }
            InlineButtonsDialog.prototype.getFormKey = function () { return AdvancedSamples.InlineButtonsForm.formKey; };
            InlineButtonsDialog.prototype.getDialogOptions = function () {
                var opt = _super.prototype.getDialogOptions.call(this);
                opt.width = 650;
                return opt;
            };
            InlineButtonsDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], InlineButtonsDialog);
            return InlineButtonsDialog;
        }(Serenity.PropertyDialog));
        AdvancedSamples.InlineButtonsDialog = InlineButtonsDialog;
    })(AdvancedSamples = Allocation.AdvancedSamples || (Allocation.AdvancedSamples = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    ...
    (function (AdvancedSamples) {
         ...
         */
        var InlineButtonsEditor = /** @class */ (function (_super) {
            __extends(InlineButtonsEditor, _super);
            function InlineButtonsEditor(container) {
                var _this = _super.call(this, container) || this;
                $('<a class="inplace-button inplace-action1"><b><i class="fa fa-bell-o"></i></b></a>')
                    .attr("title", "Do Some Action 1")
                    .insertAfter(_this.element)
                    .click(function (e) {
                    Q.notifySuccess("Action 1 with disk clicked!");
                });
                $('<a class="inplace-button inplace-action1"><b><i class="fa fa-floppy-o text-orange"></i></b></a>')
                    .attr("title", "Do Some Action 1")
                    .insertAfter(_this.element)
                    .click(function (e) {
                    Q.notifyInfo("Action 2 with bell clicked!");
                });
                return _this;
            }
            InlineButtonsEditor = __decorate([
                Serenity.Decorators.registerEditor()
            ], InlineButtonsEditor);
            return InlineButtonsEditor;
        }(Serenity.StringEditor));
        AdvancedSamples.InlineButtonsEditor = InlineButtonsEditor;
    })(AdvancedSamples = Allocation.AdvancedSamples || (Allocation.AdvancedSamples = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
...
(function (Allocation) {
    var AdvancedSamples;
    (function (AdvancedSamples) {
        var PickerOrderDetailsEditor = /** @class */ (function (_super) {
            __extends(PickerOrderDetailsEditor, _super);
            function PickerOrderDetailsEditor(container) {
                return _super.call(this, container) || this;
            }
            PickerOrderDetailsEditor.prototype.getColumnsKey = function () { return "Northwind.OrderDetail"; };
            PickerOrderDetailsEditor.prototype.getDialogType = function () { return Allocation.Northwind.OrderDetailDialog; };
            PickerOrderDetailsEditor.prototype.getLocalTextPrefix = function () { return Allocation.Northwind.OrderDetailRow.localTextPrefix; };
            PickerOrderDetailsEditor.prototype.validateEntity = function (row, id) {
                ...
                row.ProductName = Allocation.Northwind.ProductRow.getLookup().itemById[row.ProductID].ProductName;
                row.LineTotal = (row.Quantity || 0) * (row.UnitPrice || 0) - (row.Discount || 0);
                return true;
            };
            PickerOrderDetailsEditor.prototype.getButtons = function () {
                var _this = this;
                ...
                buttons.push({
                    ...
                    cssClass: "add-button",
                    onClick: function () {
                        var dlg = new AdvancedSamples.ProductPickerDialog();
                        dlg.onSuccess = function (selected) {
                            // filter already existing products
                            selected = selected.filter(function (x) { return !Q.any(_this.view.getItems(), function (y) { return y.ProductID == x.ProductID; }); });
            ...
            PickerOrderDetailsEditor = __decorate([
                Serenity.Decorators.registerClass()
            ], PickerOrderDetailsEditor);
            return PickerOrderDetailsEditor;
        }(Allocation.Common.GridEditorBase));
        AdvancedSamples.PickerOrderDetailsEditor = PickerOrderDetailsEditor;
    })(AdvancedSamples = Allocation.AdvancedSamples || (Allocation.AdvancedSamples = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    var AdvancedSamples;
    (function (AdvancedSamples) {
        var PickerOrderDialog = /** @class */ (function (_super) {
            __extends(PickerOrderDialog, _super);
            //protected form = new PickerOrderForm(this.idPrefix);
            function PickerOrderDialog() {
                return _super.call(this) || this;
            }
            PickerOrderDialog.prototype.getFormKey = function () { return AdvancedSamples.PickerOrderForm.formKey; };
            PickerOrderDialog.prototype.getIdProperty = function () { return Allocation.Northwind.OrderRow.idProperty; };
            PickerOrderDialog.prototype.getLocalTextPrefix = function () { return Allocation.Northwind.OrderRow.localTextPrefix; };
            PickerOrderDialog.prototype.getNameProperty = function () { return Allocation.Northwind.OrderRow.nameProperty; };
            PickerOrderDialog.prototype.getService = function () { return Allocation.Northwind.OrderService.baseUrl; };
            PickerOrderDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], PickerOrderDialog);
            return PickerOrderDialog;
        }(Serenity.EntityDialog));
        AdvancedSamples.PickerOrderDialog = PickerOrderDialog;
    })(AdvancedSamples = Allocation.AdvancedSamples || (Allocation.AdvancedSamples = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    ...
    (function (Northwind) {
        var OrderGrid = /** @class */ (function (_super) {
            ...
            OrderGrid.prototype.getButtons = function () {
                ...
                buttons.push(Allocation.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
...
(function (Allocation) {
    var AdvancedSamples;
    (function (AdvancedSamples) {
        var PickerOrderGrid = /** @class */ (function (_super) {
            __extends(PickerOrderGrid, _super);
            function PickerOrderGrid() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            PickerOrderGrid.prototype.getDialogType = function () { return AdvancedSamples.PickerOrderDialog; };
            PickerOrderGrid = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.filterable()
            ], PickerOrderGrid);
            return PickerOrderGrid;
        }(Allocation.Northwind.OrderGrid));
        AdvancedSamples.PickerOrderGrid = PickerOrderGrid;
    })(AdvancedSamples = Allocation.AdvancedSamples || (Allocation.AdvancedSamples = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
...
(function (Allocation) {
    var AdvancedSamples;
    (function (AdvancedSamples) {
        var ProductCheckGrid = /** @class */ (function (_super) {
            __extends(ProductCheckGrid, _super);
            function ProductCheckGrid(container) {
                var _this = _super.call(this, container) || this;
                _this.rowSelection = new Serenity.GridRowSelectionMixin(_this);
                return _this;
            }
            ProductCheckGrid.prototype.getColumnsKey = function () { return "Northwind.Product"; };
            ProductCheckGrid.prototype.getDialogType = function () { return Allocation.Northwind.ProductDialog; };
            ProductCheckGrid.prototype.getIdProperty = function () { return Allocation.Northwind.ProductRow.idProperty; };
            ProductCheckGrid.prototype.getLocalTextPrefix = function () { return Allocation.Northwind.ProductRow.localTextPrefix; };
            ProductCheckGrid.prototype.getService = function () { return Allocation.Northwind.ProductService.baseUrl; };
            ProductCheckGrid.prototype.getColumns = function () {
                var _this = this;
                var columns = _super.prototype.getColumns.call(this);
                columns.splice(0, 0, Serenity.GridRowSelectionMixin.createSelectColumn(function () { return _this.rowSelection; }));
                return columns;
            };
            ProductCheckGrid.prototype.usePager = function () {
                return false;
            };
            ProductCheckGrid.prototype.getInitialTitle = function () {
                return null;
            };
            ProductCheckGrid.prototype.getButtons = function () {
                var buttons = _super.prototype.getButtons.call(this);
                buttons = buttons.filter(function (x) { return x.cssClass != 'add-button'; });
                return buttons;
            };
            Object.defineProperty(ProductCheckGrid.prototype, "selectedItems", {
                get: function () {
                    var _this = this;
            ...
            ProductCheckGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], ProductCheckGrid);
            return ProductCheckGrid;
        }(Serenity.EntityGrid));
        AdvancedSamples.ProductCheckGrid = ProductCheckGrid;
    })(AdvancedSamples = Allocation.AdvancedSamples || (Allocation.AdvancedSamples = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    var AdvancedSamples;
    (function (AdvancedSamples) {
        var ProductPickerDialog = /** @class */ (function (_super) {
            __extends(ProductPickerDialog, _super);
            function ProductPickerDialog() {
                var _this = _super.call(this) || this;
                _this.checkGrid = new AdvancedSamples.ProductCheckGrid(_this.byId("CheckGrid"));
                _this.dialogTitle = "Select Products";
                return _this;
            }
            ProductPickerDialog.prototype.getTemplate = function () {
                return "<div id=\"~_CheckGrid\"></div>";
            };
            ProductPickerDialog.prototype.getDialogOptions = function () {
                var _this = this;
                var opt = _super.prototype.getDialogOptions.call(this);
                opt.buttons = [
                    {
            ...
            Object.defineProperty(ProductPickerDialog.prototype, "selectedItems", {
                get: function () {
            ...
            ProductPickerDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], ProductPickerDialog);
            return ProductPickerDialog;
        }(Serenity.TemplatedDialog));
        AdvancedSamples.ProductPickerDialog = ProductPickerDialog;
    })(AdvancedSamples = Allocation.AdvancedSamples || (Allocation.AdvancedSamples = {}));
})(Allocation || (Allocation = {}));
/// <reference path="../../../Northwind/Order/OrderGrid.ts" />
var Allocation;
(function (Allocation) {
    var AdvancedSamples;
    (function (AdvancedSamples) {
        var LongRunningActionGrid = /** @class */ (function (_super) {
            __extends(LongRunningActionGrid, _super);
            function LongRunningActionGrid(container) {
                return _super.call(this, container) || this;
            }
            LongRunningActionGrid.prototype.createToolbarExtensions = function () {
                _super.prototype.createToolbarExtensions.call(this);
                this.rowSelection = new Serenity.GridRowSelectionMixin(this);
            };
            LongRunningActionGrid.prototype.getButtons = function () {
                var _this = this;
                return [{
                        title: 'Perform Long Running Action on Selected Orders',
                        ...
                        onClick: function () {
                            ...
                            if (!keys.length) {
                                Q.notifyError("Please select some orders!");
                                return;
                            }
                            Q.confirm("Perform action on " + keys.length + " selected orders?", function () {
                                var operationID = "myOperationID_" + new Date().getTime();
                                AdvancedSamples.LongRunningService.Action({
                                    OrderIDs: keys,
                                ...
                                var progressDialog = new Allocation.BasicProgressDialog();
                                ...
                                function updateProgress() {
                                    ...
                                    if (progressDialog && progressDialog.cancelled) {
                                        AdvancedSamples.LongRunningService.Cancel({
                                            OperationID: operationID
                                        }, function (response) {
                                    ...
                                    AdvancedSamples.LongRunningService.Status({
                                        OperationID: operationID
                                    }, function (r) {
                                        if (!progressDialog)
                                            return;
            ...
            LongRunningActionGrid.prototype.getColumns = function () {
                var _this = this;
                var columns = _super.prototype.getColumns.call(this);
                columns.splice(0, 0, Serenity.GridRowSelectionMixin.createSelectColumn(function () { return _this.rowSelection; }));
                return columns;
            };
            LongRunningActionGrid.prototype.getViewOptions = function () {
                var opt = _super.prototype.getViewOptions.call(this);
                opt.rowsPerPage = 2500;
                return opt;
            };
            LongRunningActionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], LongRunningActionGrid);
            return LongRunningActionGrid;
        }(Allocation.Northwind.OrderGrid));
        AdvancedSamples.LongRunningActionGrid = LongRunningActionGrid;
    })(AdvancedSamples = Allocation.AdvancedSamples || (Allocation.AdvancedSamples = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    ...
    (function (AdvancedSamples) {
        var DataConnectionEditor = /** @class */ (function (_super) {
            ...
            DataConnectionEditor.prototype.getService = function () {
                return AdvancedSamples.DataExplorerService.baseUrl;
            };
        ...
        }(Allocation.ServiceEditorBase));
        AdvancedSamples.DataConnectionEditor = DataConnectionEditor;
    })(AdvancedSamples = Allocation.AdvancedSamples || (Allocation.AdvancedSamples = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    ...
    (function (AdvancedSamples) {
        var DataExplorerGrid = /** @class */ (function (_super) {
            ...
            DataExplorerGrid.prototype.getInitialTitle = function () { return "Data Explorer"; };
            DataExplorerGrid.prototype.getLocalTextPrefix = function () { return ""; };
            DataExplorerGrid.prototype.getService = function () { return AdvancedSamples.DataExplorerService.baseUrl; };
            ...
            DataExplorerGrid.prototype.createToolbarExtensions = function () {
                ...
                this.connection = Serenity.Widget.create({
                    type: AdvancedSamples.DataConnectionEditor,
                ...
                this.table = Serenity.Widget.create({
                    type: AdvancedSamples.DataTableEditor,
                    options: {
                ...
                this.table.change(function (e) {
                    ...
                    if (Q.isEmptyOrNull(table))
                        return;
                    AdvancedSamples.DataExplorerService.ListColumns({
                        ConnectionKey: _this.connection.value,
                        TableName: table
                    }, function (response) {
                        _this.slickGrid.setColumns(_this.propertyItemsToSlickColumns(response.Entities));
                        _this.refresh();
                    });
                });
            };
        ...
        AdvancedSamples.DataExplorerGrid = DataExplorerGrid;
    })(AdvancedSamples = Allocation.AdvancedSamples || (Allocation.AdvancedSamples = {}));
})(Allocation || (Allocation = {}));
/// <reference path="../../../Common/Helpers/ServiceEditorBase.ts" />
var Allocation;
(function (Allocation) {
    ...
    (function (AdvancedSamples) {
        ...
        AdvancedSamples.DataTableEditor = DataTableEditor;
    })(AdvancedSamples = Allocation.AdvancedSamples || (Allocation.AdvancedSamples = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        ...
        }(Allocation.Northwind.ProductDialog));
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        ...
        }(Allocation.Northwind.ProductGrid));
        ...
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: Allocation.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: Allocation.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new Allocation.Northwind.OrderDialog();
                        ...
                        var chai = Allocation.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = Allocation.Northwind.EmployeeRow.getLookup().items
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(Allocation.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        ...
        }(Allocation.Northwind.OrderDialog));
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    Allocation.Northwind.CategoryService.Retrieve({
        ...
        }(Allocation.Northwind.CategoryDialog));
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        ...
        }(Allocation.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(Allocation.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new Allocation.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                Allocation.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(Allocation.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    Allocation.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(Allocation.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(Allocation.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    Allocation.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return Allocation.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return Allocation.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return Allocation.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return Allocation.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var SupplierDialog = /** @class */ (function (_super) {
            ...
            SupplierDialog.prototype.getLanguages = function () {
                return Allocation.LanguageList.getValue();
            };
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        ...
        }(Allocation.Northwind.SupplierDialog));
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(Allocation.Northwind.SupplierGrid));
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return Allocation.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return Allocation.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return Allocation.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return Allocation.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return Allocation.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                Allocation.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    Allocation.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(Allocation.Northwind.CustomerDialog));
        ...
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.createToolbarExtensions = function () {
                ...
                new Serenity.CardViewMixin({
                    grid: this,
                    itemTemplate: "\n<table>\n    <tr>\n        <td rowspan=\"4\" class=\"img\"><img :src=\"getRandomImage(item)\" /></td>\n    </tr>\n    <tr>\n        <td class=\"name\"><a href=\"#\" @click.prevent=\"editItem(item)\">{{item.CustomerID}} - {{item.CompanyName}}</a></td>\n    </tr>\n    <tr>\n        <td class=\"contact\">{{item.ContactName}}, {{item.ContactTitle}}</td>\n    </tr>\n    <tr>\n        <td class=\"country\">{{item.City}}, {{item.Country}}</td>\n    </tr>\n</table>",
                    methods: {
                        editItem: function (item) {
                            self.editItem(item.ID);
                        },
                        getRandomImage: function (item, index) {
            ...
            CustomerGrid.prototype.getIncludeColumns = function (include) {
                ...
                include[Northwind.CustomerRow.Fields.CustomerID] = true;
                include[Northwind.CustomerRow.Fields.CompanyName] = true;
                include[Northwind.CustomerRow.Fields.ContactName] = true;
                include[Northwind.CustomerRow.Fields.ContactTitle] = true;
                include[Northwind.CustomerRow.Fields.Country] = true;
                include[Northwind.CustomerRow.Fields.City] = true;
            };
            CustomerGrid.prototype.getPersistanceStorage = function () {
                return new Allocation.Common.UserPreferenceStorage();
            };
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        ...
        }(Allocation.Northwind.CustomerGrid));
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = Allocation.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return Allocation.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(Allocation.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return Allocation.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Allocation.Northwind.OrderDetailForm(_this.idPrefix);
                ...
                _this.form.ProductID.cascadeField = Allocation.Northwind.ProductRow.Fields.CategoryID;
                return _this;
        ...
        }(Allocation.Northwind.OrderDetailDialog));
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        ...
        }(Allocation.Northwind.OrderDetailsEditor));
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return Allocation.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return Allocation.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return Allocation.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return Allocation.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return Allocation.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (Allocation) {
    ...
    Allocation.StaticTextBlock = StaticTextBlock;
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    var BasicSamples;
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        ...
        }(Allocation.Common.BulkServiceAction));
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return Allocation.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return Allocation.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return Allocation.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return Allocation.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = Allocation.Northwind.ProductRow.Fields;
    ...
    (function (BasicSamples) {
        var CustomLinksInGrid = /** @class */ (function (_super) {
            ...
            CustomLinksInGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = Allocation.Northwind.OrderRow.Fields;
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(Allocation.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new Allocation.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new Allocation.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new Allocation.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, Allocation.Northwind.OrderRow.Fields.ShipCountry);
...
(function (Allocation) {
    ...
    Allocation.SelectableEntityGrid = SelectableEntityGrid;
})(Allocation || (Allocation = {}));
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return Allocation.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return Allocation.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return Allocation.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return Allocation.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(Allocation.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = Allocation.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            Allocation.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return Allocation.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return Allocation.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return Allocation.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return Allocation.Northwind.ProductService.baseUrl; };
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return Allocation.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return Allocation.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return Allocation.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return Allocation.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return Allocation.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return Allocation.Northwind.CustomerGrossSalesRow.localTextPrefix; };
        ...
        var TreeGrid = /** @class */ (function (_super) {
            ...
            function TreeGrid(container) {
                ...
                _this.treeMixin = new Serenity.TreeGridMixin({
                    ...
                    toggleField: Allocation.Northwind.OrderRow.Fields.CustomerCompanyName,
...
(function (Allocation) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return Allocation.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return Allocation.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return Allocation.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
        ...
        var MeetingAttendeeEditor = /** @class */ (function (_super) {
            ...
            MeetingAttendeeEditor.prototype.createToolbarExtensions = function () {
                ...
                Serenity.Widget.create({
                    type: Serenity.LookupEditor,
                    options: {
                        lookupKey: Allocation.Organization.ContactRow.lookupKey
                    },
                    ...
                    init: function (w) { return w.changeSelect2(function (x) {
                        if (Q.isEmptyOrNull(w.value))
                            return;
                        var contact = Allocation.Organization.ContactRow.getLookup().itemById[Q.toId(w.value)];
                        w.value = null;
                        if (!contact)
                            return;
                    ...
                    Q.serviceCall({
                        ...
                        onError: function (response) {
                            ...
                            if (response != null && response.Error != null && !Q.isEmptyOrNull(response.Error.Message)) {
                                ...
                                _this.form.Password.element.focus();
                                return;
                            }
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: Allocation.Authorization.userDefinition.DisplayName,
