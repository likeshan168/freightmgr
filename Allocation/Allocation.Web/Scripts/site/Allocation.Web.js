        ...
        (function (ExcelExportHelper) {
            function createToolButton(options) {
                return {
                    ...
                    cssClass: Q.coalesce(options.cssClass, 'export-xlsx-button'),
                    onClick: function () {
                        if (!options.onViewSubmit()) {
                            return;
                        }
...
(function (Allocation) {
    var Allot;
    (function (Allot) {
        var IdCardDialog = /** @class */ (function (_super) {
            __extends(IdCardDialog, _super);
            function IdCardDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Allot.IdCardForm(_this.idPrefix);
                return _this;
            }
            IdCardDialog.prototype.getFormKey = function () { return Allot.IdCardForm.formKey; };
            IdCardDialog.prototype.getIdProperty = function () { return Allot.IdCardRow.idProperty; };
            IdCardDialog.prototype.getLocalTextPrefix = function () { return Allot.IdCardRow.localTextPrefix; };
            IdCardDialog.prototype.getNameProperty = function () { return Allot.IdCardRow.nameProperty; };
            IdCardDialog.prototype.getService = function () { return Allot.IdCardService.baseUrl; };
            IdCardDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive(),
        ...
        Allot.IdCardDialog = IdCardDialog;
...
(function (Allocation) {
    var Allot;
    (function (Allot) {
        var IdCardExcelImportDialog = /** @class */ (function (_super) {
            __extends(IdCardExcelImportDialog, _super);
            function IdCardExcelImportDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Allot.IdCardExcelImportForm(_this.idPrefix);
                return _this;
            }
            IdCardExcelImportDialog.prototype.getDialogTitle = function () {
                return "导入Excel";
            };
            IdCardExcelImportDialog.prototype.getDialogButtons = function () {
                var _this = this;
                return [
                    {
                        text: '导入',
            ...
            IdCardExcelImportDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], IdCardExcelImportDialog);
            return IdCardExcelImportDialog;
        }(Serenity.PropertyDialog));
        Allot.IdCardExcelImportDialog = IdCardExcelImportDialog;
    })(Allot = Allocation.Allot || (Allocation.Allot = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    var Allot;
    (function (Allot) {
        var IdCardGrid = /** @class */ (function (_super) {
            __extends(IdCardGrid, _super);
            function IdCardGrid(container) {
                return _super.call(this, container) || this;
            }
            IdCardGrid.prototype.getColumnsKey = function () { return 'Allot.IdCard'; };
            IdCardGrid.prototype.getDialogType = function () { return Allot.IdCardDialog; };
            IdCardGrid.prototype.getIdProperty = function () { return Allot.IdCardRow.idProperty; };
            IdCardGrid.prototype.getLocalTextPrefix = function () { return Allot.IdCardRow.localTextPrefix; };
            IdCardGrid.prototype.getService = function () { return Allot.IdCardService.baseUrl; };
            IdCardGrid.prototype.getSlickOptions = function () {
            ...
            IdCardGrid.prototype.createSlickGrid = function () {
                var grid = _super.prototype.createSlickGrid.call(this);
                grid.setSelectionModel(new Slick.RowSelectionModel());
                return grid;
            };
            IdCardGrid.prototype.getButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getButtons.call(this);
                buttons.push({
                    title: "导入Excel",
                    cssClass: 'makeimport',
                    onClick: function () {
                        var dialog = new Allot.IdCardExcelImportDialog();
                ...
                buttons.push(Allocation.Common.ExcelExportHelper.createToolButton({
                    ...
                    cssClass: "makeexport",
                    grid: this,
                    service: Allot.IdCardService.baseUrl + '/ListExcel',
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        Q.postToService({
                            service: Allot.IdCardService.baseUrl + '/ExcelTemplate',
                            request: null,
                            target: '_blank'
                        });
                    },
            ...
            IdCardGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], IdCardGrid);
            return IdCardGrid;
        }(Serenity.EntityGrid));
        Allot.IdCardGrid = IdCardGrid;
    })(Allot = Allocation.Allot || (Allocation.Allot = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    var Allot;
    (function (Allot) {
        var DeclarationDataDialog = /** @class */ (function (_super) {
...
(function (Allocation) {
    var Allot;
    (function (Allot) {
        var DeclarationDataExcelImportDialog = /** @class */ (function (_super) {
...
(function (Allocation) {
    var Allot;
    (function (Allot) {
        var DeclarationDataGrid = /** @class */ (function (_super) {
...
(function (Allocation) {
    var Allot;
    (function (Allot) {
        var IsCheckedFormatter = /** @class */ (function () {
...
(function (Allocation) {
    var Allot;
    (function (Allot) {
        var TenantFormatter = /** @class */ (function () {
...
(function (Allocation) {
    var Allot;
    (function (Allot) {
        var ApiDialog = /** @class */ (function (_super) {
            __extends(ApiDialog, _super);
            function ApiDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Allot.ApiForm(_this.idPrefix);
                return _this;
            }
            ApiDialog.prototype.getFormKey = function () { return Allot.ApiForm.formKey; };
            ApiDialog.prototype.getIdProperty = function () { return Allot.ApiRow.idProperty; };
            ApiDialog.prototype.getLocalTextPrefix = function () { return Allot.ApiRow.localTextPrefix; };
            ApiDialog.prototype.getNameProperty = function () { return Allot.ApiRow.nameProperty; };
            ApiDialog.prototype.getService = function () { return Allot.ApiService.baseUrl; };
            ApiDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive(),
                Serenity.Decorators.panel()
            ], ApiDialog);
...
(function (Allocation) {
    var Allot;
    (function (Allot) {
        var ApiGrid = /** @class */ (function (_super) {
            __extends(ApiGrid, _super);
            function ApiGrid(container) {
                return _super.call(this, container) || this;
            }
            ApiGrid.prototype.getColumnsKey = function () { return 'Allot.Api'; };
            ApiGrid.prototype.getDialogType = function () { return Allot.ApiDialog; };
            ApiGrid.prototype.getIdProperty = function () { return Allot.ApiRow.idProperty; };
            ApiGrid.prototype.getLocalTextPrefix = function () { return Allot.ApiRow.localTextPrefix; };
            ApiGrid.prototype.getService = function () { return Allot.ApiService.baseUrl; };
            ApiGrid.prototype.addButtonClick = function () {
                this.editItem({
                    IsEnabled: true,
                    ReuseCount: 10
                });
            };
            ApiGrid.prototype.getSlickOptions = function () {
                var opt = _super.prototype.getSlickOptions.call(this);
                opt.enableTextSelectionOnCells = true;
                opt.selectedCellCssClass = "slick-row-selected";
                opt.enableCellNavigation = true;
            ...
            ApiGrid.prototype.createSlickGrid = function () {
                var grid = _super.prototype.createSlickGrid.call(this);
                grid.setSelectionModel(new Slick.RowSelectionModel());
                return grid;
            };
...
(function (Allocation) {
    ...
    (function (Allot) {
        var ApiForm = /** @class */ (function (_super) {
            ...
            ApiForm.formKey = 'Allot.Api';
            return ApiForm;
        }(Serenity.PrefixedContext));
        Allot.ApiForm = ApiForm;
        [['Title', function () { return Serenity.StringEditor; }], ['ApiUrl', function () { return Serenity.StringEditor; }], ['UserName', function () { return Serenity.StringEditor; }], ['Password', function () { return Serenity.StringEditor; }], ['AppKey', function () { return Serenity.StringEditor; }], ['Price', function () { return Serenity.DecimalEditor; }], ['IsEnabled', function () { return Serenity.BooleanEditor; }], ['ReuseCount', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(ApiForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Allot = Allocation.Allot || (Allocation.Allot = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    ...
    (function (Allot) {
        var ApiRow;
        (function (ApiRow) {
            ApiRow.idProperty = 'Id';
            ApiRow.nameProperty = 'Title';
            ApiRow.localTextPrefix = 'Allot.Api';
            ApiRow.lookupKey = 'Allot.Api';
            function getLookup() {
                return Q.getLookup('Allot.Api');
            }
            ApiRow.getLookup = getLookup;
            var Fields;
            (function (Fields) {
            })(Fields = ApiRow.Fields || (ApiRow.Fields = {}));
            [
                'Id',
                'Title',
                'ApiUrl',
        ...
        })(ApiRow = Allot.ApiRow || (Allot.ApiRow = {}));
    })(Allot = Allocation.Allot || (Allocation.Allot = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    ...
    (function (Allot) {
        var ApiService;
        (function (ApiService) {
            ApiService.baseUrl = 'Allot/Api';
            var Methods;
            (function (Methods) {
            })(Methods = ApiService.Methods || (ApiService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                ApiService[x] = function (r, s, o) {
                    return Q.serviceRequest(ApiService.baseUrl + '/' + x, r, s, o);
                };
                Methods[x] = ApiService.baseUrl + '/' + x;
            });
        })(ApiService = Allot.ApiService || (Allot.ApiService = {}));
    })(Allot = Allocation.Allot || (Allocation.Allot = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    var Allot;
    (function (Allot) {
        var DeclarationDataExcelImportForm = /** @class */ (function (_super) {
...
(function (Allocation) {
    var Allot;
    (function (Allot) {
        var DeclarationDataForm = /** @class */ (function (_super) {
        ...
        [['Flight', function () { return Serenity.StringEditor; }], ['MasterAwb', function () { return Serenity.StringEditor; }], ['SubAwb', function () { return Serenity.StringEditor; }], ['Amount', function () { return Serenity.IntegerEditor; }], ['Weight', function () { return Serenity.DecimalEditor; }], ['Description', function () { return Serenity.StringEditor; }], ['Status', function () { return Serenity.StringEditor; }], ['IsChecked', function () { return Serenity.EnumEditor; }]].forEach(function (x) { return Object.defineProperty(DeclarationDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Allot = Allocation.Allot || (Allocation.Allot = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
...
(function (Allocation) {
    ...
    (function (Allot) {
        var IdCardExcelImportForm = /** @class */ (function (_super) {
            ...
            IdCardExcelImportForm.formKey = 'Allot.IdCardExcelImport';
            return IdCardExcelImportForm;
        }(Serenity.PrefixedContext));
        Allot.IdCardExcelImportForm = IdCardExcelImportForm;
        [['ApiId', function () { return Serenity.LookupEditor; }], ['FileName', function () { return Serenity.ImageUploadEditor; }]].forEach(function (x) { return Object.defineProperty(IdCardExcelImportForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Allot = Allocation.Allot || (Allocation.Allot = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
    var Allot;
    (function (Allot) {
        var IdCardForm = /** @class */ (function (_super) {
            __extends(IdCardForm, _super);
            function IdCardForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            IdCardForm.formKey = 'Allot.IdCard';
            return IdCardForm;
        }(Serenity.PrefixedContext));
        Allot.IdCardForm = IdCardForm;
        [['AuthenticationType', function () { return Serenity.StringEditor; }], ['Name', function () { return Serenity.StringEditor; }], ['CardNo', function () { return Serenity.StringEditor; }], ['CheckResult', function () { return Serenity.StringEditor; }], ['RequestDate', function () { return Serenity.DateEditor; }], ['RequestIp', function () { return Serenity.StringEditor; }], ['Price', function () { return Serenity.DecimalEditor; }]].forEach(function (x) { return Object.defineProperty(IdCardForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Allot = Allocation.Allot || (Allocation.Allot = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
...
(function (Allocation) {
    ...
    (function (Allot) {
        ...
        (function (IdCardRow) {
            ...
            IdCardRow.nameProperty = 'AuthenticationType';
            IdCardRow.localTextPrefix = 'Allot.IdCard';
            var Fields;
            (function (Fields) {
            })(Fields = IdCardRow.Fields || (IdCardRow.Fields = {}));
            [
                'Id',
                'AuthenticationType',
                'Name',
...
(function (Allocation) {
    ...
    (function (Allot) {
        var IdCardService;
        (function (IdCardService) {
            IdCardService.baseUrl = 'Allot/IdCard';
            var Methods;
            (function (Methods) {
            })(Methods = IdCardService.Methods || (IdCardService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                IdCardService[x] = function (r, s, o) {
                    return Q.serviceRequest(IdCardService.baseUrl + '/' + x, r, s, o);
                };
                Methods[x] = IdCardService.baseUrl + '/' + x;
            });
        })(IdCardService = Allot.IdCardService || (Allot.IdCardService = {}));
    })(Allot = Allocation.Allot || (Allocation.Allot = {}));
})(Allocation || (Allocation = {}));
var Allocation;
(function (Allocation) {
